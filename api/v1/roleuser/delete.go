...
func (s *Server) DeleteRoleUser(ctx context.Context, in *approleuser.DeleteRoleUserRequest) (*approleuser.DeleteRoleUserResponse, error) {
	...
	if _, err := uuid.Parse(in.GetID()); err != nil {
		...
		return &approleuser.DeleteRoleUserResponse{}, status.Error(codes.InvalidArgument, "ID is invalid")
	}
	...
	if err != nil {
		...
		return &approleuser.DeleteRoleUserResponse{}, status.Error(codes.Internal, err.Error())
	}
