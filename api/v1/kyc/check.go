...
func validateKycCreate(ctx context.Context, info *kyc.CreateKycRequest) error {
	...
	default:
		...
		return status.Error(codes.InvalidArgument, "DocumentType is infovalid")
	}
	...
	default:
		...
		return status.Error(codes.InvalidArgument, "EntityType is infovalid")
	}
