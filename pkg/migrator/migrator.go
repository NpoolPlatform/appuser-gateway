...
//			SetCardType(uidStr).
//			SetCardID(uidStr).
//			SetFrontCardImg(uidStr).
//			SetBackCardImg(uidStr).
//			SetUserHandingCardImg(uidStr).
//			Save(ctx)
//		if err != nil {
//			return err
//		}
...
//		fmt.Println("**********************err")
//		fmt.Println(err)
//		_, err = reviewCli.Review.
//			Create().
//			SetObjectID(uid).
//			SetObjectType(uidStr).
//			SetAppID(uid).
//			SetDomain(uidStr).
...
//			subQuery := entsql.Select(reviewtb.FieldObjectID, entsql.As(entsql.Max(reviewtb.FieldUpdateAt), reviewtb.FieldUpdateAt)).
//				From(entsql.Table(reviewtb.Table)).Where(entsql.In(reviewtb.FieldObjectID, kycIDs)).
//				GroupBy(reviewtb.FieldObjectID)
//			s.
//				LeftJoin(subQuery).
//				On(
//					s.C(reviewtb.FieldObjectID),
//					subQuery.C(reviewtb.FieldObjectID),
//				).On(
