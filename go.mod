...
require (
	github.com/NpoolPlatform/appuser-middleware v0.0.0-20240914085813-9e12ef9fb5ff
	...
	github.com/NpoolPlatform/inspire-middleware v0.0.0-20240914083154-064581964812
