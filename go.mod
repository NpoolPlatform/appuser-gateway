...
require (
	github.com/NpoolPlatform/appuser-manager v0.0.0-20220822073332-7735c7b7393e
	github.com/NpoolPlatform/appuser-middleware v0.0.0-20220821131255-b84d979e86a3
